                 ...
                 <div className="space-y-16">
                   ...
                   <div className="space-y-8">
                     <div className="space-y-4 max-w-xs">
                       <Button asChild className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 rounded-none font-light text-sm tracking-[0.1em] uppercase transition-all duration-300">
                       ...
                       <div className="relative">
                         <Button asChild variant="ghost" className="w-full h-12 text-muted-foreground hover:text-foreground hover:bg-transparent rounded-none font-light text-sm transition-all duration-300">
                           <Link to="/auth">
                             Sign in
                           </Link>
                         </Button>
