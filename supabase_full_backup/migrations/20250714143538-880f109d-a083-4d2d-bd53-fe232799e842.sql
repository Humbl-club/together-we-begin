...
DROP INDEX IF EXISTS idx_social_posts_status_created_at;
DROP INDEX IF EXISTS idx_social_posts_user_status;
...
DROP INDEX IF EXISTS idx_events_status_time_composite;
DROP INDEX IF EXISTS idx_social_posts_user_status_time;
DROP INDEX IF EXISTS idx_challenge_participations_user_completed;
DROP INDEX IF EXISTS idx_loyalty_transactions_user_type_time;
DROP INDEX IF EXISTS idx_events_upcoming_status;
DROP INDEX IF EXISTS idx_challenges_active_only;
DROP INDEX IF EXISTS idx_events_search;
DROP INDEX IF EXISTS idx_posts_search;
DROP INDEX IF EXISTS idx_profiles_search;
DROP INDEX IF EXISTS idx_events_created_by_status;
DROP INDEX IF EXISTS idx_event_registrations_user_event;
DROP INDEX IF EXISTS idx_social_posts_user_status_created;
DROP INDEX IF EXISTS idx_challenges_status_dates;
